...
| **모델 독립적**           | [pi-ai](https://github.com/earendil-works/pi-ai) 기반: Anthropic, OpenAI, Google 등이 하나의 인터페이스 뒤에 있습니다. 환경변수 하나로 모델 교체, 코드 변경 없음, 락인 없음. |
...
기본적으로 모두 활성화되며 개별적으로 비활성화할 수 있습니다.
...
berry-agent의 메커니즘 계층은 **berry**, **pi**, **dsh**, **opencode**에서
검증된 아이디어를 계승합니다 — 학문적 뿌리는 Emacs의 "에디터는 인터프리터다"와
VS Code의 특권 이중 트랙 교훈에 있습니다. LLM 접근은
[pi-ai](https://github.com/earendil-works/pi-ai)로 구동됩니다. 코드 자체는
제로부터의 독립적 재작성입니다.
